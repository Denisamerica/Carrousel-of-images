...
function renderSlides() {
  ...
  if (images.length === 0) {
    ...
    empty.innerHTML = '<div style="display:grid;place-items:center;height:100%;color:#8f9ab1;text-align:center;padding:1rem;">Upload images to preview the carousel</div>';
    track.append(empty);
    return;
  }
